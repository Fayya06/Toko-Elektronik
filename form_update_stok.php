...
<div class="container">
<form action="update_stok.php" method="$_POST">
<center><h2> PENGEDITAN DATA STOK BARANG </h2></center>
<hr>

</div>
<div class="form-group">
    <td><label for="nama_elektronik"> Nama Elektronik </label></td>
    <td><input type="text" name="nama_elektronik" id="nama_elektronik" value="<?php echo $row['nama_elektronik'];?>" class="form-control"></td>
</div>
